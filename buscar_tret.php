...
<html lang="es">
    ...
    <head>
        ...
        <script type="text/javascript" src="media/js/jsonTret.js"></script>   
        ...
        <script>
            ...
            function seleccionaItem(id){
				window.opener.selectTret(id, <?=$op?>, <?=$tipo?>);
    ...
    <body style="background: white; width: 100%;">
        <div class="container-fluid">
            ...
            <div class="table-responsive"> 
				...
				<input type="hidden" name="tipo_retencion_ad" id="tipo_retencion_ad" value="<?=$tipo_retencion_ad?>">
