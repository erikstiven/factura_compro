...
<script src="key_table/js/KeyTable.js" type="text/javascript"></script>    
...
<script>
	...
	function datos(op, a, b, c){
		if(c == 1){
			if(op == 0){
				window.opener.document.form1.fisc_b.value = a;
				window.opener.document.getElementById("fisc_b_tmp").innerHTML = b;
			}else if(op == 1){
				window.opener.document.form1.fisc_s.value = a;
				window.opener.document.getElementById("fisc_s_tmp").innerHTML = b;
			}
...
<?	
	$cont=1;
	echo '<table class="display KeyTable" id="example" align="center" width="98%" style="border:#999999 1px solid">';
