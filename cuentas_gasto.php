...
<script>
	function datos(op, a, b, c){
		if(c == 1){
	        if(op==0){
	            window.opener.document.form1.gasto1.value = a;
	            window.opener.document.getElementById("gasto_val").innerHTML = b;
	            window.opener.cargar_centroCostos3();
	        }else if(op==1){
	            window.opener.document.form1.gasto2.value = a;
	            window.opener.document.getElementById("gasto_val2").innerHTML = b;
	            window.opener.cargar_centroCostos4();
	        }
